          ...
          child: SizedBox(
            ...
            children: [
              ...
              _MissionTile(
                ...
                title: AppStrings.t(context, 'earnStepCare'),
                subtitle: AppStrings.t(context, 'earnStepCareDesc'),
                done: false,
              ),
              _MissionTile(
  ...
  Widget build(BuildContext context) {
    ...
    return Padding(
      ...
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(AppStrings.t(context, 'shopBrowse'), style: const TextStyle(color: AppColors.textPrimary, fontSize: 18, fontWeight: FontWeight.w600)),
          const SizedBox(height: 12),
          SizedBox(
            height: 38,
              ...
              itemBuilder: (context, i) {
                ...
                return GestureDetector(
                  ...
                  child: AnimatedContainer(
                    ...
                    alignment: Alignment.center,
                    decoration: BoxDecoration(
                      color: active ? AppColors.pastelOrange.withValues(alpha: 0.22) : AppColors.darkCard,
                      borderRadius: BorderRadius.circular(20),
                      border: Border.all(
                        color: active ? AppColors.pastelOrangeDark : Colors.white12,
                      ),
                    ),
                    child: Text(
                      ...
                      style: TextStyle(
                        ...
                        fontSize: 12,
                        color: active ? AppColors.pastelOrange : AppColors.textSecondary,
                      ),
                    ),
                  ),
                );
